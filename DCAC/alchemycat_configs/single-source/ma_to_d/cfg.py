...
cfg = Config(caps=('alchemycat_configs/base/model.yaml',
                   ...
                   'alchemycat_configs/base/data/dataset2.yaml',
...
cfg.DATASETS.EVAL_DATASET = 'dukemtmc'
...
#用于保存增强后的数据集的路径
cfg.DATASETS.AUGMENTED_DATA_PATH = "/mnt/data_hdd1/yangj/pbr/augmented_data/augmented-dukemtmcreid"