...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str,
                        default="/home/yangj/cluster-contrast-reid/examples/logs/model_best.pth.tar",
                        metavar='PATH')
    # testing configs
    ...
    parser.add_argument('--data-dir', type=str, metavar='PATH',
                        default='/mnt/data_hdd1/yangj/pbr/data')
    parser.add_argument('--pooling-type', type=str, default='gem')
    parser.add_argument('--embedding_features_path', type=str,
                        default='/home/yangj/cluster-contrast-reid/embedding_features/mark1501_res50_ibn')
    main()
